...
const SocialSide = () => {
    ...
    return (
        <div className="fixed left-0 bottom-0 md:top-[50%] md:-translate-y-[25%] z-10 ">
            <ul className={`${isExpand ? 'translate-y-0 gap-1' : 'opacity-0 translate-y-[104%] pointer-events-none'} mx-2 md:mx-0 md:opacity-100 md:translate-y-0 md:pointer-events-auto transition-all duration-500 flex flex-col`}>
